# `libpolymake_julia_jll.jl` (v0.8.0+2)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ebeb7414d1673ed762865451dcd74c2e54574c0a/L/libpolymake_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://github.com/oscar-system/libpolymake-julia/archive/v0.8.0.tar.gz (SHA256 checksum: `da459c1fc819a446cfa683cc8e6e890a54194b7a943ac8d62c4c71061512dbee`)
