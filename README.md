# `libpolymake_julia_jll.jl` (v0.14.3+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c4b84bac543b628e147f49c60f247faecbb8d6a5/L/libpolymake_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libpolymake-julia.git (revision: `60a4ba16b5e68ea163be3060a15c583e4af435a7`)
