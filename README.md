# `libpolymake_julia_jll.jl` (v0.10.1+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/39cb090aeec568173865a104b45fd406ca586d4a/L/libpolymake_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libpolymake-julia.git (revision: `8af54c01018c27b59116309af91bb49964d4a995`)
