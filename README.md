# `libpolymake_julia_jll.jl` (v0.10.6+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/3cd6fbe92730bb3ab9cc4afbd762430d359703c4/L/libpolymake_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libpolymake-julia.git (revision: `6502403aad3230483ab43283822e1a9b10eda11c`)
