# `libpolymake_julia_jll.jl` (v0.7.0+0)
...
* compressed archive: https://github.com/oscar-system/libpolymake-julia/archive/v0.7.0.tar.gz (SHA256 checksum: `ac13f05beb59e688d485a96759666d9d2a0bd026f6dfacdfd7d4e3e88abc4202`)
