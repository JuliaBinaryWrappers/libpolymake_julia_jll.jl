# `libpolymake_julia_jll.jl` (v0.8.1+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/6f842bdd404021135ec25291678cec7f5df63de7/L/libpolymake_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://github.com/oscar-system/libpolymake-julia/archive/v0.8.1.tar.gz (SHA256 checksum: `cd905d195a0e371408274462fef7e8c7e3351850155ae2976dd3e335e40baf5c`)
