# `libpolymake_julia_jll.jl` (v0.11.1+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/7f76eb3916b8d55c0b1bf989463efe2053c3d0cc/L/libpolymake_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libpolymake-julia.git (revision: `56a5401082e90340d55208bc41a107aa444f82ba`)
