# `libpolymake_julia_jll.jl` (v0.8.3+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/a6bc8b76bf44dd91bf54e7e4456065fe2e581188/L/libpolymake_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libpolymake-julia.git (revision: `8111b73c57fe3fdea811ed79baaa85735fdaf294`)
